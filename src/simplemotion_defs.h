...
#define SMP_OSW_DEGREES_MAX 120			// 0-32000
#define SMP_OSW_JOYSTICK_POS 121					// -32768-32767

#define SMP_OSW_TORQUE_SETPOINT 122		// -32768-32767
#define SMP_OSW_VELOCITY_FB 123

#define SMP_OSW_VELOCITY_FILTER_SAMPLES 124

#define SMP_OSW_PARAMETER 125
    #define OSW_FLAG_ENABLE	BV(1)
    #define OSW_FLAG_AUTOSTART BV(2)
